...
class UserSettings(context: Context) {
    ...
    companion object {
        ...
        private const val HOME_URL = "web-content.home_url"
        private const val WEBSITE_BLACKLIST = "web-content.website_blacklist"
        private const val WEBSITE_WHITELIST = "web-content.website_whitelist"
        ...
        private const val ALLOW_REFRESH = "web-browsing.allow_refresh"
        private const val ALLOW_BACKWARDS_NAVIGATION = "web-browsing.allow_backwards_navigation"
    }
}
