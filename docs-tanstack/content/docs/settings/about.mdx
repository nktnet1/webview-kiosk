...
The display name of the application, e.g. <code>{APP_NAME}</code>
...
### 1.12. Source Code URL

The link to the application's source code, e.g. https://github.com/nktnet1/webview-kiosk
