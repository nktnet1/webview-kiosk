...
(e.g. together with termux) to set {APP_NAME} as a Device Owner.
...
Using OwnDroid, you can add {APP_NAME} to the allowlist of applications that can
...
This can be used to block trackers and unwanted ads in {APP_NAME}, which
