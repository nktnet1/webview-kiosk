...
If your device is fully managed (company-owned), you can use 
[managed configurations](https://developer.android.com/work/managed-configurations) 
to remotely restrict or modify {APP_NAME} settings from your MDM.
...
For example, [Headwind MDM does not support this](https://github.com/h-mdm/hmdm-server/issues/49#issuecomment-1151156032).

Below are instructionsffor certain EMM/MDMs:
