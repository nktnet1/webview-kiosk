...
**Android API:** [WebSettings#setMediaPlaybackRequiresUserGesture(boolean)](https://developer.android.com/reference/android/webkit/WebSettings#setMediaPlaybackRequiresUserGesture(boolean))

**Default:** true

## 15. Mutual TLS

Configure exact sites that may use a client certificate for
...
When {APP_NAME} is the device/profile owner, an explicitly configured alias
