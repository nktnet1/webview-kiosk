...
## 5. Refresh on Network Available

Select when the page should automatically refresh when network connectivity
is restored.
...
**Default:** On Page Error

## 6. Refresh on Loading Error Interval (seconds)
