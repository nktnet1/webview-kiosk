---
title: Device
description: Rotation, camera, microphone, location, vibration, unlock controls
---
...
Set to true to allow web pages to vibrate the device using
[`navigator.vibrate(pattern)`](https://developer.mozilla.org/en-US/docs/Web/API/Navigator/vibrate).
The pattern can be a duration in milliseconds or an array of alternating
vibration and pause durations.

The app declares Android's
[`VIBRATE`](https://developer.android.com/reference/android/Manifest.permission#VIBRATE)
permission, while this setting controls whether the API is available to web
content.
...
### 16.2. Dhizuku Request Permission on Launch
