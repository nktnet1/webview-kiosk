...
kiosk-launch or MQTT, the notification will always be created irrespective of
this {APP_NAME} setting. You will need to disable notifications at the device
level if you do not want them.
