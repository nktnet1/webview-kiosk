---
title: JS Scripts
description: Theme, viewport, Web APIs, custom scripts
---
...
## 5. Enable Vibration API

When enabled, web pages can vibrate the device using
