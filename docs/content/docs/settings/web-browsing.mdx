...
| Find       | Opens a search bar to find matching text on the web page. |
| Scroll Top | Scrolls to the top of the web page. |
| Scroll Bot | Scrolls to the bottom of the web page. |
| Apps       | Opens a dialog allowing you to launch other apps. When in locked/kiosk mode, only apps configured as `Lock Task Packages` under the Device Owner settings will be available. |
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        When in locked/kiosk mode, only apps configured as <code>Lock Task Packages</code>
        under the Device Owner settings will be available.
      </td>
    </tr>
    <tr>
      <td>
