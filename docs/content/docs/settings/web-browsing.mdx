...
Set to true to allow the user to refresh the page, e.g. by pulling down from
the top 1/4 of the screen, when at the top of the webpage.
...
## 10. Allow Link Long Press Context Menu
