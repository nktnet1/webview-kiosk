...
1. Tapping the top-left quadrant of the screen 10 times in quick succession (300ms interval)
...
Set to true to allow viewing and editing the navigation history (past visited sites) by
