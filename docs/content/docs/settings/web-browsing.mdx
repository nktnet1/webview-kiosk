...
| Apps       | Opens a dialog allowing you to launch other apps (only visible when unlocked). |
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Opens a dialog allowing you to launch other apps. This option will
        only be visible if the device is not in locked mode.
      </td>
    </tr>
    <tr>
      <td>
