...
You should only use WebSocket when absolutely necessary, e.g. when connected to
a network with a firewall that blocks non-standard ports. This is because using
WebSocket will consume more resources.
