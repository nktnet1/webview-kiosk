...
1. [Eclipse Mosquitto](https://github.com/eclipse-mosquitto/mosquitto) and
   ...
   <Callout title="Tip" type="info">
      ...
      - https://github.com/RcRaCk2k/ha_webview_kiosk
...
[PowerManager.PARTIAL_WAKE_LOCK](https://developer.android.com/reference/android/os/PowerManager.html#PARTIAL_WAKE_LOCK)).
...
[[APP_NAME]] to stop the service from being killed.
