...
Shows a notification on the device. Only the 5 most recent notifications will
be displayed.

The following parameters can be configured in the data value:

| Property        | Type     | Default   | Description                                                        |
|-----------------|----------|-----------|--------------------------------------------------------------------|
| `contentTitle`  | string?  | `MQTT`    | The title of the notification.                                     |
| `contentText`   | string   | —         | **(required)** The content body of the notification.               |
