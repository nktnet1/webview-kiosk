...
| `wakeScreen` | boolean *(optional)* | Whether to wake the screen if it is turned off. This will require `Settings -> MQTT -> Use Foreground Service` to be true. <br />**Default:** `false`|
