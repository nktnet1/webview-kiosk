...
| `reloadActivity` | boolean *(optional)* | Whether the activity should be reloaded, which is necessary for some settings to to take effect (e.g. `device.rotation`)<br />**Default:** `true`     |
