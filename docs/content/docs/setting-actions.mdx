...
When selecting `Export`, a dialog will appear showing all user settings encoded as
either `Base64` or `JSON`.

To import this value, simply paste the string in the `Import` dialog under the
same format you exported with.
