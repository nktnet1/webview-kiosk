---
title: Installation
description: Supported platforms to download the app.
---
...
import FDroidBadge from "#/assets/badges/f-droid.svg";
import GitHubBadge from "#/assets/badges/github.svg";
import IzzyOnDroidBadge from "#/assets/badges/izzy-on-droid.svg";
import ObtainiumBadge from "#/assets/badges/obtainium.svg";
...
<Step>
Go to the <Link href="/provision-device">{APP_NAME} Provision Device</Link> page to generate a QR code.
</Step>
