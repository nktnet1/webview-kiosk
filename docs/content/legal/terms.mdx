...
description: Terms of use for the Webview Kiosk Android app
---
...
rights, and other intellectual property rights related to the Application
...
features, and may result in the Application not functioning correctly or at
all.
